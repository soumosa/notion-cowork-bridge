  ...
  server.registerTool(
    ...
    async () => {
      const info = {
        ...
        terminalCommandPolicy: "audit_only_no_denied_patterns",
        fileToolsWorkspaceScoped: true,
        backgroundProcessLimits: {
          maxProcesses: MAX_BACKGROUND_PROCESSES,
          perProcessLogBytes: BACKGROUND_LOG_LIMIT_BYTES,
        ...
        browserLimits: {
          ...
          ttlSeconds: BROWSER_TTL_SECONDS,
        },
        auditLog: AUDIT_PATH,
      };
